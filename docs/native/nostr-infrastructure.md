...
| Relay search       | [NIP-50](https://github.com/nostr-protocol/nips/blob/master/50.md)                         | One multi-filter REQ: `search` + `#t` + bounded recent-sample fallback (web parity); always re-match locally, never assume universal relay support. |
